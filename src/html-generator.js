    ...
    <div class = 'd-flex justify-content-center row'>
      ...
      <div class="card mx-5 mb-3 shadow " style="width: 18rem;">
        <div class="card-body bg-primary">
          ...
          <p class="card-role text-light">Role</p>
        </div>
        <div class = "p-3 bg-light">
          <ul class="list-group list-group-flush border ">
            <li class="list-group-item list-id">ID:</li>
            <li class="list-group-item list-email">Email:</li>
            <li class="list-group-item list-to-be-filled">TBD: </li>
          </ul>
        </div>
      </div>

      <div class="card mx-3 mb-3 shadow " style="width: 18rem;">
        <div class="card-body bg-primary">
          <h5 class="card-name text-light">Name</h5>
          <p class="card-role text-light">Role</p>
        </div>
